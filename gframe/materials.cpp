...
Materials::Materials() {
	...
	mCoverTop.AmbientColor = 0xffffffff;
	mCoverTop.DiffuseColor = 0xff000000;
	mCoverTop.ColorMaterial = irr::video::ECM_NONE;
	mCoverTop.MaterialType = irr::video::EMT_TRANSPARENT_ALPHA_CHANNEL;
