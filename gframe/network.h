...
//new
#define CTOS_STOP_CLIENT		0xdf
#define CTOS_NETWORK_CLIENT_ID	0xdd
//#define CTOS_REFRESH_HOST 	0cdd
...
//new
#define STOC_STOP_CLIENT	0xdf
#define STOC_NETWORK_SERVER_ID	0xdd
#define STOS_VERSION_CHECK 	0xdc
